...
<div class="row">
  ...
  <h3>Edit Shipping Mode</h3>
    <div class="form-group col-xs-12">
      <label>Name:</label>
      <input type="text" class="form-control input-sm" name="name" value="<?php echo $transport_type->name; ?>">
    </div>
    <div class="form-group col-xs-12">
      <label>Description:</label>
      <textarea class="form-control input-sm" name="description"><?php echo $transport_type->description
      ; ?></textarea>
    </div>
