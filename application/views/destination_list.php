<div class="row">
  ...
  <div class="call_to_action">
    <a href="<?php echo base_url(); ?>destinations/create"><button class="btn btn-primary"><img src="<?php echo base_url(); ?>media/images/icons/building_add.png" />&nbsp;ADD OFFICE</button></a>
  </div>
