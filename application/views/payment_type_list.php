<div class="row">
  ...
  <div class="call_to_action">
    <a href="<?php echo base_url(); ?>paymenttypes/create"><button class="btn btn-primary"><img src="<?php echo base_url(); ?>media/images/icons/payment_types_add.png" />&nbsp;ADD PAYMENT TYPE</button></a>
  </div>
