<div class="row">
  ...
  <div class="call_to_action">
    <a href="<?php echo base_url(); ?>transporttypes/create"><button class="btn btn-primary"><img src="<?php echo base_url(); ?>media/images/icons/shipping_modes_add.png" />&nbsp;ADD SHIPPING MODE</button></a>
  </div>
