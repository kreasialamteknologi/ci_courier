<div class="row">
  ...
  <div class="call_to_action">
    <a href="<?php echo base_url(); ?>cargotypes/create"><button class="btn btn-primary"><img src="<?php echo base_url(); ?>media/images/icons/parcel_type_add.png" />&nbsp;ADD PARCEL TYPE</button></a>
  </div>
