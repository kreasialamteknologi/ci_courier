<div class="row">
  ...
  <div class="call_to_action">
    <a href="<?php echo base_url(); ?>parcels/create"><button class="btn btn-primary"><img src="<?php echo base_url(); ?>media/images/icons/parcel_add.png" />&nbsp;ADD CONSIGNMENT</button></a>
    <a href="<?php echo base_url(); ?>parcels/batch_edit"><button class="btn btn-success"><img src="<?php echo base_url(); ?>media/images/icons/wand.png" />&nbsp;BATCH UPDATE</button></a>
  ...
  <div class="row row_item">
    ...
    <div class="col-md-1">
      ...
      <a href="<?php echo base_url(); ?>parcels/delete/<?php echo $parcel->id; ?>"><img src="<?php echo base_url(); ?>media/images/icons/delete.png" title="Delete Consignment" alt="Delete"/></a>
    </div>
  </div>
  <?php } ?>
  <div class="row">
