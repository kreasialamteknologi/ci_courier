...
<div class="row">
  <div class="col-md-5">
	...
	<div class="col-md-6 left"><label class="readonly"><?php echo $parcel[0]->weight; ?> KG</label></div>
      </div>
      <div class="row">
	...
	<div class="col-md-6 left"><label class="readonly"><?php echo $parcel[0]->batch_no; ?></label></div>
      </div>
      <div class="row">
