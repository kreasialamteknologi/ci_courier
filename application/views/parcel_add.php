...
<div class="row">
  ...
  <h3>Sender/Shipper Details</h3>
    <div class="form-group col-xs-12">
      ...
      <input type="text" class="form-control input-sm" name="sender_name" placeholder="Enter Sender's Name">
    </div>
    
    <div class="form-group col-xs-12">
      <label class="must">Sender's Reference No:</label>
      <input type="text" class="form-control input-sm" name="sender_reference" placeholder="12-Digit Reference Number">
    </div>
    
    <div class="form-group col-xs-12">
      <label class="must">Telephone No:</label>
      <input type="text" class="form-control input-sm" name="sender_telephone" placeholder="Enter Telephone Number">
    </div>
    
    <div class="form-group col-xs-12">
      <label>Address Details:</label>
      <textarea class="form-control input-sm" name="sender_address" placeholder="Enter Full Address"></textarea>
    </div>
    
    <div class="form-group col-xs-12">
      <label>Account Number:</label>
      <input type="text" class="form-control input-sm" name="account_no" placeholder="Enter Account Number - 8 Digit">
    </div>
    <div class="form-group col-xs-12">
      <label>Country:</label>
  ...
  <h3>Receiver/Consignee Details</h3>
    <div class="form-group col-xs-12">
      ...
      <input type="text" class="form-control input-sm" name="receiver_name" placeholder="Enter Receiver's Number">
    </div>    
    
    <div class="form-group col-xs-12">
      <label class="must">Reference No:</label>
      <input type="text" class="form-control input-sm" name="receiver_reference" placeholder="12-Digit Reference Number">
    </div>
        	
    <div class="form-group col-xs-12">
      <label class="must">Telephone No:</label>
      <input type="text" class="form-control input-sm" name="receiver_telephone" placeholder="Enter Telephone Number">
    </div>
    
    <div class="form-group col-xs-12">
      <label>Address Details:</label>
      <textarea class="form-control input-sm" name="receiver_address" placeholder="Enter Full Address"></textarea>
    </div>
    
    <div class="form-group col-xs-12">
      <label>City/Town:</label>
      <input type="text" class="form-control input-sm" name="receiver_town" placeholder="Enter City/Town Name">
    </div>
...
<h3 class="centered">Parcel/Cargo Details</h3>
  <div class="col-md-4 fieldset">
	...
	<input type="text" class="form-control input-sm" name="invoice_no" placeholder="5-Digit Invoice Number">
      </div>
  ...
  <div class="col-md-4 fieldset">
	...
	<input type="datetime-local" class="form-control input-sm" name="departure_date" id="datetime">
      </div>
  ...
  <div class="col-md-12 fieldset">
	  ...
	  <label>&nbsp;</label>
		<button type="submit" class="btn btn-success">SAVE CONSIGNMENT</button>
	      </div>
  </div>
</form>
  </div>
